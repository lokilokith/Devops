...
login_model = auth_ns.model(
    "LoginModel",
    {
        "username": fields.String(
            required=True, description="Username or Email", example="admin"
        ),
        "password": fields.String(
            required=True, description="Password", example="secret123"
        ),
    },
)
...
token_data_model = auth_ns.model(
    "TokenData",
    {
        ...
        "expires_in": fields.Integer(
            required=True, description="Expiration time in seconds", example=3600
        ),
    },
)

token_response_model = auth_ns.model(
    "TokenResponse",
    {
...
user_me_data_model = auth_ns.model(
    "UserMeData",
    {
        ...
        "permissions": fields.List(
            fields.String, description="List of assigned permissions"
        ),
    },
)

user_me_response_model = auth_ns.model(
    "UserMeResponse",
    {
        "success": fields.Boolean(default=True),
