...
user_model = identity_ns.model("User", {
    "id": fields.String(description="User UUID", example="12345678-1234-5678-1234-567812345678"),
    **user_base,
    "last_login_at": fields.String(description="Last login timestamp", example="2023-01-01T12:00:00Z")
})

user_create_model = identity_ns.model("UserCreate", {
...
user_update_model = identity_ns.model("UserUpdate", {
    "full_name": fields.String(required=True, description="Full Name"),
    "title": fields.String(required=False, description="Job Title"),
    "status": fields.String(required=True, description="Status", example="active")
})

user_patch_model = identity_ns.model("UserPatch", {
    "full_name": fields.String(description="Full Name"),
    "title": fields.String(description="Job Title"),
    "status": fields.String(description="Status", example="active")
})

user_response_model = identity_ns.model("UserResponse", {
...
user_list_response_model = identity_ns.model("UserListResponse", {
    "success": fields.Boolean,
    "message": fields.String,
