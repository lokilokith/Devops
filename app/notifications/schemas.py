...
notification_list_response_model = Model(
...
notification_single_response_model = Model(
...
notification_mark_all_response_model = Model(
...
notification_list_parser.add_argument(
    "priority", type=str, required=False, location="args"
)
notification_list_parser.add_argument(
    "is_read", type=str, required=False, location="args"
)
notification_list_parser.add_argument(
    "recipient", type=str, required=False, location="args"
)
notification_list_parser.add_argument(
    "created_after", type=str, required=False, location="args"
)
notification_list_parser.add_argument(
    "created_before", type=str, required=False, location="args"
)
notification_list_parser.add_argument(
    "limit", type=int, required=False, default=50, location="args"
)
notification_list_parser.add_argument(
    "offset", type=int, required=False, default=0, location="args"
)
