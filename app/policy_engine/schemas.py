...
policies_ns = Namespace("policy-engine", description="Policy Engine management and evaluation")

policy_base = {
    "name": fields.String(description="Policy Name", example="Restrict Production Access"),
    "description": fields.String(description="Policy Description", example="Only allow during working hours"),
    "conditions": fields.Raw(description="ABAC Conditions (JSON)", example={"allowed_hours": {"start": "09:00", "end": "18:00"}}),
    "max_duration_seconds": fields.Integer(description="Max Session Duration", example=3600),
...
policy_create_model = policies_ns.model(
    "PolicyCreate",
    {
        ...
        "requires_approval": fields.Boolean(description="Approval Required", default=True),
        "effect": fields.String(description="Effect", default="allow", enum=["allow", "deny"]),
...
policy_evaluate_context_model = policies_ns.model(
    "PolicyEvaluateContext",
    {
        ...
        "time": fields.String(description="ISO-8601 UTC Time", example="2023-01-01T12:00:00Z"),
    },
)
...
policy_evaluate_request_model = policies_ns.model(
    "PolicyEvaluateRequest",
    {
        ...
        "resource_id": fields.String(required=True, description="Resource UUID or Code"),
        "action": fields.String(required=True, description="Permission Action"),
        "context": fields.Nested(policy_evaluate_context_model, description="Evaluation Context"),
    },
)
