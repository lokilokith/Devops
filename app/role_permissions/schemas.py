...
role_permissions_list_response_model = role_permissions_ns.model("RolePermissionsListResponse", {
    "success": fields.Boolean,
    "message": fields.String,
...
permission_roles_list_response_model = role_permissions_ns.model("PermissionRolesListResponse", {
    "success": fields.Boolean,
    "message": fields.String,
