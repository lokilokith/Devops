...
role_model = roles_ns.model(
    "Role",
    {
        "id": fields.String(
            description="Role UUID", example="12345678-1234-5678-1234-567812345678"
        ),
        **role_base,
    },
)

role_create_model = roles_ns.model(
    "RoleCreate",
    {
...
role_update_model = roles_ns.model(
    "RoleUpdate",
    {
        "role_name": fields.String(required=True, description="Role Name"),
        "description": fields.String(required=False, description="Description"),
...
role_patch_model = roles_ns.model(
    "RolePatch",
    {
...
role_response_model = roles_ns.model(
    "RoleResponse",
    {
...
role_list_response_model = roles_ns.model(
    "RoleListResponse",
    {
        "success": fields.Boolean,
        "message": fields.String,
