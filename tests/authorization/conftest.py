...
def populated_db(db_session):
    ...
    r1 = Role(role_code="ROL1", role_name="R1", role_type=RoleType.SYSTEM, status=RoleStatus.ACTIVE)
    ...
    res2 = Resource(resource_code="RES2", resource_name="Res2", resource_type=ResourceType.DATABASE, status=ResourceStatus.ACTIVE)
