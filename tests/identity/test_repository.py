...
def test_search_users(db_session):
    repo = IdentityRepository(db_session)
    user1 = User(employee_id="SEARCH-01", username="alpha", email="alpha@test.com", full_name="Alpha Team")
    user2 = User(employee_id="SEARCH-02", username="beta", email="beta@test.com", full_name="Beta Team")
    user3 = User(employee_id="SEARCH-03", username="gamma", email="gamma@xyz.com", full_name="Gamma Squad")
...
def test_count_users(db_session):
    ...
    user1 = User(employee_id="COUNT-01", username="count1", email="c1@test.com", full_name="Count 1")
    user2 = User(employee_id="COUNT-02", username="count2", email="c2@test.com", full_name="Count 2")
