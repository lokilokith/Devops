...
def test_search_users(service, mock_repo):
    u1 = User(username="admin", email="admin@test.com", employee_id="1", full_name="Admin")
    u2 = User(username="guest", email="guest@test.com", employee_id="2", full_name="Guest")
